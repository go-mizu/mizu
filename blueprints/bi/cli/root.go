...
func Execute(ctx context.Context) error {
	root := &cobra.Command{
		Use:   "bi",
		Short: "BI - Metabase-like Business Intelligence Tool",
		Long: `BI is a lightweight, self-hosted business intelligence platform inspired by Metabase.
...
Get started:
  bi init      Initialize the database
  bi serve     Start the BI server
  bi seed      Seed with sample data`,
	...
	// Global flags
	root.SetVersionTemplate("bi {{.Version}}\n")
