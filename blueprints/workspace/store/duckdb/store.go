// Package duckdb provides a DuckDB-backed store for Workspace.
package duckdb
...
func (s *Store) Stats(ctx context.Context) (map[string]any, error) {
	...
	tables := []string{"users", "workspaces", "members", "pages", "blocks", "databases", "views", "comments", "shares", "activities", "notifications"}
