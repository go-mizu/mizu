...
func NewServe() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: `Start the Workspace web server.

The server provides:
  - Web UI for document editing and collaboration
  - REST API for programmatic access
  - Real-time updates for collaboration

Examples:
  workspace serve                    # Start on default port 8080
  workspace serve --addr :3000       # Start on port 3000
  workspace serve --dev              # Enable development mode`,
		RunE: runServe,
	}
