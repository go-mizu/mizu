...
func NewInit() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: `Initialize the Workspace database with the required schema.
...
Examples:
  workspace init                          # Initialize default database
  workspace init --data /path/to/dir      # Initialize at specific directory`,
		RunE: runInit,
	}
