...
func NewInit() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: `Initialize the Spreadsheet database with the required schema.
...
Examples:
  spreadsheet init                          # Initialize default database
  spreadsheet init --data /path/to/dir      # Initialize at specific directory`,
		RunE: runInit,
	}
