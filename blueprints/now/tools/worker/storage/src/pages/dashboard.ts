...
<div class="dash">
  <aside class="dash-side" id="sidebar">
    <div class="dash-side-inner">
      <button class="dash-tab active" data-section="overview" onclick="go('overview')">
      ...
      <button class="dash-tab" data-section="files" onclick="go('files')">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
        Files
      </button>
      <button class="dash-tab" data-section="events" onclick="go('events')">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
        Events
      </button>
      <button class="dash-tab" data-section="audit" onclick="go('audit')">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
        Audit Log
      </button>
      <button class="dash-tab" data-section="shares" onclick="go('shares')">
      ...
      <button class="dash-tab" data-section="keys" onclick="go('keys')">
      ...
      <button class="dash-tab" data-section="settings" onclick="go('settings')">
