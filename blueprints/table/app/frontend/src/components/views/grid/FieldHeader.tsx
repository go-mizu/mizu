...
const FIELD_TYPE_ICONS: Record<FieldType, string> = {
  ...
  single_line_text: 'M4 6h16M4 12h16m-7 6h7',
  long_text: 'M4 6h16M4 10h16M4 14h16M4 18h10',
  rich_text: 'M4 6h16M4 10h16M4 14h16M4 18h10',
  ...
  collaborator: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z',
