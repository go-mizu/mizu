    ...
    <div className="h-full overflow-auto bg-gray-50 p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={fetchDashboardData}
            className="px-3 py-1.5 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-md flex items-center gap-1.5"
            disabled={isLoading}
          >
          ...
          <button
            ...
            className="px-3 py-1.5 text-sm bg-primary text-white rounded-md hover:bg-primary-dark flex items-center gap-1.5"
          >
      ...
      {dashboardConfig.widgets.length === 0 ? (
        <div className="flex flex-col items-center justify-center h-64 bg-white rounded-lg border-2 border-dashed border-gray-300">
          ...
          <p className="text-sm text-gray-500 mb-4">Add charts, numbers, and lists to visualize your data</p>
          <button
            onClick={() => setShowAddWidget(true)}
            className="px-4 py-2 bg-primary text-white rounded-md hover:bg-primary-dark"
          >
