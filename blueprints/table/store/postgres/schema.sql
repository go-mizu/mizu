-- Table Store Schema for PostgreSQL
...
-- Records (rows with JSONB cells for efficient querying)
...
CREATE INDEX IF NOT EXISTS idx_records_cells ON records USING GIN (cells);
