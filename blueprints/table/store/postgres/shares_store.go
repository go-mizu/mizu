...
// SharesStore provides PostgreSQL-based share storage.
...
func (s *SharesStore) Create(ctx context.Context, share *shares.Share) error {
	...
	`, share.ID, share.BaseID, nullString(share.TableID), nullString(share.ViewID), share.Type, share.Permission, nullString(share.UserID), nullString(share.Email), nullString(share.Token), share.ExpiresAt, share.CreatedBy, share.CreatedAt)
	return err
}
