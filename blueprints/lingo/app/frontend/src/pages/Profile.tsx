...
export default function Profile() {
  ...
  return (
    <Container size="md">
      {/* Profile Header */}
      <Paper p="xl" radius="lg" mb="xl" style={{ backgroundColor: '#1a2c33' }}>
        <Group justify="space-between" align="start">
          <Group>
            ...
            <div>
              ...
              <Text style={{ color: '#8fa8b2' }}>@{user?.username}</Text>
              <Group gap="lg" mt="md">
                <Group gap={4}>
          ...
          <Group>
            <ActionIcon variant="subtle" size="lg" radius="xl">
              <IconEdit size={20} style={{ color: '#8fa8b2' }} />
            </ActionIcon>
            <ActionIcon variant="subtle" size="lg" radius="xl">
              <IconSettings size={20} style={{ color: '#8fa8b2' }} />
            </ActionIcon>
          </Group>
        </Group>
      </Paper>
      ...
      <Grid mb="xl">
        <Grid.Col span={4}>
          <Paper p="lg" radius="lg" style={{ backgroundColor: '#1a2c33', textAlign: 'center' }}>
            <Text size="2rem" fw={800} style={{ color: '#58cc02' }}>
              {mockStats.wordsLearned}
            </Text>
            <Text size="sm" style={{ color: '#8fa8b2' }}>Words Learned</Text>
          </Paper>
        </Grid.Col>
        <Grid.Col span={4}>
          <Paper p="lg" radius="lg" style={{ backgroundColor: '#1a2c33', textAlign: 'center' }}>
            ...
            <Text size="sm" style={{ color: '#8fa8b2' }}>Lessons Completed</Text>
          </Paper>
        </Grid.Col>
        <Grid.Col span={4}>
          <Paper p="lg" radius="lg" style={{ backgroundColor: '#1a2c33', textAlign: 'center' }}>
            ...
            <Text size="sm" style={{ color: '#8fa8b2' }}>Time Learning</Text>
          </Paper>
        </Grid.Col>
      </Grid>
      ...
      {/* Weekly Activity */}
      <Paper p="xl" radius="lg" mb="xl" style={{ backgroundColor: '#1a2c33' }}>
        <Title order={4} mb="lg" style={{ color: 'white' }}>This Week</Title>
              ...
              <div style={{ height: 100, display: 'flex', alignItems: 'flex-end' }}>
                <div
                  style={{
                    ...
                    backgroundColor: day.xp > 0 ? '#58cc02' : '#3d5a68',
                    borderRadius: 4,
                    minHeight: 4,
                  }}
                />
              </div>
              <Text size="xs" fw={600} style={{ color: '#8fa8b2' }}>{day.day}</Text>
      ...
      <Paper p="xl" radius="lg" mb="xl" style={{ backgroundColor: '#1a2c33' }}>
        <Group justify="space-between" mb="lg">
          <Title order={4} style={{ color: 'white' }}>Achievements</Title>
      ...
      <Paper p="xl" radius="lg" mb="xl" style={{ backgroundColor: '#1a2c33' }}>
        <Group justify="space-between">
          <div>
            <Title order={4} style={{ color: 'white' }}>Current Streak</Title>
            <Text style={{ color: '#8fa8b2' }}>Keep learning every day!</Text>
          </div>
          <Group>
        ...
        <Text size="sm" ta="center" mt="sm" style={{ color: '#8fa8b2' }}>
