...
type Options struct {
	...
	// NoClone skips DOM cloning before extraction.
	NoClone bool
	// SkipBaselineRescue skips the baseline rescue pass.
	SkipBaselineRescue bool
	// SkipFullMetadata extracts only the page title.
	SkipFullMetadata bool
	// SkipLanguageDetection skips the whatlanggo language classifier.
