...
import { Search, Trash2, MoreVertical, Clock } from 'lucide-react'
        ...
        actions={
          recentSearches.length > 0 ? (
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 text-sm text-[#d93025] hover:bg-[#d93025]/5 rounded-lg transition-colors"
            >
              <Trash2 size={16} />
              Clear all
            </button>
