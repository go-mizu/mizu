(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function s(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=s(n);fetch(n.href,i)}})();class yt{routes=[];currentPath="";notFoundRenderer=null;addRoute(t,s){const a=t.split("/").filter(Boolean);this.routes.push({pattern:t,segments:a,renderer:s})}setNotFound(t){this.notFoundRenderer=t}navigate(t,s=!1){t!==this.currentPath&&(s?history.replaceState(null,"",t):history.pushState(null,"",t),this.resolve())}start(){window.addEventListener("popstate",()=>this.resolve()),document.addEventListener("click",t=>{const s=t.target.closest("a[data-link]");if(s){t.preventDefault();const a=s.getAttribute("href");a&&this.navigate(a)}}),this.resolve()}getCurrentPath(){return this.currentPath}resolve(){const t=new URL(window.location.href),s=t.pathname,a=bt(t.search);this.currentPath=s+t.search;for(const n of this.routes){const i=wt(n.segments,s);if(i!==null){n.renderer(i,a);return}}this.notFoundRenderer&&this.notFoundRenderer({},a)}}function wt(e,t){const s=t.split("/").filter(Boolean);if(e.length===0&&s.length===0)return{};if(e.length!==s.length)return null;const a={};for(let n=0;n<e.length;n++){const i=e[n],r=s[n];if(i.startsWith(":"))a[i.slice(1)]=decodeURIComponent(r);else if(i!==r)return null}return a}function bt(e){const t={};return new URLSearchParams(e).forEach((a,n)=>{t[n]=a}),t}const xe="/api";async function p(e,t){let s=`${xe}${e}`;if(t){const n=new URLSearchParams;Object.entries(t).forEach(([r,o])=>{o!==void 0&&o!==""&&o!==null&&n.set(r,o)});const i=n.toString();i&&(s+=`?${i}`)}const a=await fetch(s);if(!a.ok)throw new Error(`API error: ${a.status} ${a.statusText}`);return a.json()}async function P(e,t){const s=await fetch(`${xe}${e}`,{method:"POST",headers:{"Content-Type":"application/json"},body:t?JSON.stringify(t):void 0});if(!s.ok)throw new Error(`API error: ${s.status} ${s.statusText}`);return s.json()}async function Pe(e,t){const s=await fetch(`${xe}${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(!s.ok)throw new Error(`API error: ${s.status} ${s.statusText}`);return s.json()}async function ae(e,t){const s=await fetch(`${xe}${e}`,{method:"DELETE",headers:t?{"Content-Type":"application/json"}:void 0,body:t?JSON.stringify(t):void 0});if(!s.ok)throw new Error(`API error: ${s.status} ${s.statusText}`);return s.json()}function Ce(e,t){const s={q:e};return t&&(t.page!==void 0&&(s.page=String(t.page)),t.per_page!==void 0&&(s.per_page=String(t.per_page)),t.time_range&&(s.time_range=t.time_range),t.region&&(s.region=t.region),t.language&&(s.language=t.language),t.safe_search&&(s.safe_search=t.safe_search),t.site&&(s.site=t.site),t.exclude_site&&(s.exclude_site=t.exclude_site),t.lens&&(s.lens=t.lens),t.verbatim&&(s.verbatim="1")),s}const f={search(e,t){return p("/search",Ce(e,t))},searchImages(e,t){const s={q:e};return t&&(t.page!==void 0&&(s.page=String(t.page)),t.per_page!==void 0&&(s.per_page=String(t.per_page)),t.size&&t.size!=="any"&&(s.size=t.size),t.color&&t.color!=="any"&&(s.color=t.color),t.type&&t.type!=="any"&&(s.type=t.type),t.aspect&&t.aspect!=="any"&&(s.aspect=t.aspect),t.time&&t.time!=="any"&&(s.time=t.time),t.rights&&t.rights!=="any"&&(s.rights=t.rights),t.filetype&&t.filetype!=="any"&&(s.filetype=t.filetype),t.safe&&(s.safe=t.safe)),p("/search/images",s)},reverseImageSearch(e){return P("/search/images/reverse",{url:e})},reverseImageSearchByUpload(e){return P("/search/images/reverse",{image_data:e})},searchVideos(e,t){return p("/search/videos",Ce(e,t))},searchNews(e,t){return p("/search/news",Ce(e,t))},searchMusic(e,t){const s=new URLSearchParams({q:e});return t?.page&&s.set("page",String(t.page)),p(`/search/music?${s}`)},searchScience(e,t){const s=new URLSearchParams({q:e});return t?.page&&s.set("page",String(t.page)),t?.per_page&&s.set("per_page",String(t.per_page)),p(`/search/science?${s}`)},searchMaps(e){const t=new URLSearchParams({q:e});return p(`/search/maps?${t}`)},searchCode(e,t){const s=new URLSearchParams({q:e});return t?.page&&s.set("page",String(t.page)),t?.per_page&&s.set("per_page",String(t.per_page)),p(`/search/code?${s}`)},searchSocial(e,t){const s=new URLSearchParams({q:e});return t?.page&&s.set("page",String(t.page)),p(`/search/social?${s}`)},suggest(e){return p("/suggest",{q:e})},trending(){return p("/suggest/trending")},calculate(e){return p("/instant/calculate",{q:e})},convert(e){return p("/instant/convert",{q:e})},currency(e){return p("/instant/currency",{q:e})},weather(e){return p("/instant/weather",{q:e})},define(e){return p("/instant/define",{q:e})},time(e){return p("/instant/time",{q:e})},knowledge(e){return p(`/knowledge/${encodeURIComponent(e)}`)},getPreferences(){return p("/preferences")},setPreference(e,t){return P("/preferences",{domain:e,action:t})},deletePreference(e){return ae(`/preferences/${encodeURIComponent(e)}`)},getLenses(){return p("/lenses")},createLens(e){return P("/lenses",e)},deleteLens(e){return ae(`/lenses/${encodeURIComponent(e)}`)},getHistory(){return p("/history")},clearHistory(){return ae("/history")},deleteHistoryItem(e){return ae(`/history/${encodeURIComponent(e)}`)},getSettings(){return p("/settings")},updateSettings(e){return Pe("/settings",e)},getBangs(){return p("/bangs")},parseBang(e){return p("/bangs/parse",{q:e})},getRelated(e){return p("/related",{q:e})},newsHome(){return p("/news/home")},newsCategory(e,t=1){return p(`/news/category/${e}`,{page:String(t)})},newsSearch(e,t){const s={q:e};return t?.page&&(s.page=String(t.page)),t?.time&&(s.time=t.time),t?.source&&(s.source=t.source),p("/news/search",s)},newsStory(e){return p(`/news/story/${e}`)},newsLocal(e){const t={};return e&&(t.city=e.city,e.state&&(t.state=e.state),t.country=e.country),p("/news/local",t)},newsFollowing(){return p("/news/following")},newsPreferences(){return p("/news/preferences")},updateNewsPreferences(e){return Pe("/news/preferences",e)},followNews(e,t){return P("/news/follow",{type:e,id:t})},unfollowNews(e,t){return ae("/news/follow",{type:e,id:t})},hideNewsSource(e){return P("/news/hide",{source:e})},setNewsLocation(e){return P("/news/location",e)},recordNewsRead(e,t){return P("/news/read",{article:e,duration:t})}};async function xt(){try{const e=await fetch("/api/suggest/trending");if(!e.ok)return[];const t=await e.json();return Array.isArray(t)?t.map(s=>typeof s=="string"?s:s.text):t.suggestions||[]}catch{return[]}}function $t(e){let t={...e};const s=new Set;return{get(){return t},set(a){t={...t,...a},s.forEach(n=>n(t))},subscribe(a){return s.add(a),()=>{s.delete(a)}}}}const ot="mizu_search_state";function kt(){try{const e=localStorage.getItem(ot);if(e)return JSON.parse(e)}catch{}return{recentSearches:[],settings:{safe_search:"moderate",results_per_page:10,region:"auto",language:"en",theme:"light",open_in_new_tab:!1,show_thumbnails:!0}}}const Q=$t(kt());Q.subscribe(e=>{try{localStorage.setItem(ot,JSON.stringify(e))}catch{}});function R(e){const t=Q.get(),s=[e,...t.recentSearches.filter(a=>a!==e)].slice(0,20);Q.set({recentSearches:s})}const Ct='<svg class="search-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>',St='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',Lt='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" x2="12" y1="19" y2="22"/></svg>',It='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"/><circle cx="12" cy="13" r="3"/></svg>',Et='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/><path d="M12 7v5l4 2"/></svg>',_t='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z"/></svg>',Bt='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>';function E(e){const t=e.size==="lg"?"search-box-lg":"search-box-sm",s=e.initialValue?Fe(e.initialValue):"",a=e.initialValue?"":"hidden",n=e.placeholder||"Search the web...";return`
  ...
  `}function zt(e){_(a=>{e.navigate(`/search?q=${encodeURIComponent(a)}`)}),document.getElementById("home-search-btn")?.addEventListener("click",()=>{const n=document.getElementById("search-input")?.value?.trim();n&&e.navigate(`/search?q=${encodeURIComponent(n)}`)}),document.getElementById("home-lucky-btn")?.addEventListener("click",()=>{const n=document.getElementById("search-input")?.value?.trim();n&&e.navigate(`/search?q=${encodeURIComponent(n)}&lucky=1`)}),document.querySelectorAll(".bang-chip").forEach(a=>{a.addEventListener("click",()=>{const n=a.dataset.bang||"",i=document.getElementById("search-input");i&&(i.value=n+" ",i.focus())})}),document.querySelectorAll(".instant-btn").forEach(a=>{a.addEventListener("click",()=>{const n=a.dataset.query||"";n&&e.navigate(`/search?q=${encodeURIComponent(n)}`)})}),Dt()}async function Dt(){try{const e=await xt(),t=document.getElementById("trending-container"),s=document.getElementById("trending-chips");t&&s&&e.length>0&&(s.innerHTML=e.slice(0,8).map(a=>`
    ...
    <div class="rich-snippet">
      ...
      ${l.price?`<span class="price">${T(String(l.price))}</span>`:""}
    </div>
  `:"";return`
    <div class="search-result" data-result-index="${t}" data-domain="${F(e.domain)}">
      <div class="result-url">
        <div class="favicon">
          <img src="${F(s)}" alt="" loading="lazy" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" />
          ${Jt}
        </div>
        <div>
          <span class="text-sm">${T(e.domain)}</span>
      ...
      <div class="flex items-start">
        <div class="flex-1">
          <div class="result-title">
            <a href="${F(e.url)}" target="_blank" rel="noopener">${T(e.title)}</a>
          </div>
          ${v}
          <div class="result-snippet">
            ${n?`<span class="result-date">${T(n)} — </span>`:""}${i}
          </div>
          ${o}
        </div>
        ${r}
  ...
  `}function ps(e){const t=e.data||{},s=t.from_value??"",a=t.from_unit??"",n=t.to_value??"",i=t.to_unit??"",r=t.category??"";return`
    <div class="instant-card conversion">
      <div class="flex items-center gap-2 text-tertiary">
        ${ns}
        <span class="instant-type">Unit Conversion${r?` - ${g(r)}`:""}</span>
      </div>
      <div class="instant-result">${g(String(n))} ${g(i)}</div>
      <div class="instant-sub">${g(String(s))} ${g(a)}</div>
    </div>
  `}function gs(e){const t=e.data||{},s=t.from_value??"",a=t.from_currency??"",n=t.to_value??"",i=t.to_currency??"",r=t.rate??"";return`
    <div class="instant-card currency">
      ...
      <div class="instant-result">${g(String(n))} ${g(i)}</div>
      ${r?`<div class="currency-rate">1 ${g(a)} = ${g(String(r))} ${g(i)}</div>`:""}
      <div class="currency-updated">${g(String(s))} ${g(a)}</div>
    </div>
  `}function vs(e){const t=e.data||{},s=t.location||"",a=t.temperature??"",n=(t.condition||"").toLowerCase(),i=t.humidity||"",r=t.wind||"";let o=rs;n.includes("cloud")||n.includes("overcast")?o=os:(n.includes("rain")||n.includes("drizzle")||n.includes("storm"))&&(o=ls);const l=[];return i&&l.push(`Humidity: ${g(i)}`),r&&l.push(`Wind: ${g(r)}`),`
  ...
  `}function ms(e){const t=e.data||{},s=t.word||e.query||"",a=t.phonetic||"",n=t.part_of_speech||"",i=t.definitions||[],r=t.synonyms||[],o=t.example||"";return`
    <div class="instant-card definition">
      ...
      ${i.length>0?i.map((c,v)=>`<div class="definition-text">${v+1}. ${g(c)}</div>`).join(""):""}
      ${o?`<div class="definition-example">"${g(o)}"</div>`:""}
      ${r.length>0?`<div class="mt-3 text-sm">
              <span class="text-tertiary">Synonyms: </span>
              <span class="text-secondary">${r.map(c=>g(c)).join(", ")}</span>
             </div>`:""}
    </div>
  `}function fs(e){const t=e.data||{},s=t.location||"",a=t.time||"",n=t.date||"",i=t.timezone||"";return`
    <div class="instant-card time">
      ...
      ${i?`<div class="time-timezone">${g(i)}</div>`:""}
    </div>
  ...
  `}function g(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const ws='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" x2="21" y1="14" y2="3"/></svg>';function bs(e){const t=e.image?`<img class="kp-image" src="${Se(e.image)}" alt="${Se(e.title)}" loading="lazy" onerror="this.style.display='none'" />`:"",s=e.facts&&e.facts.length>0?`<table class="kp-facts">
          <tbody>
            ${e.facts.map(i=>`
              <tr>
                <td class="fact-label">${W(i.label)}</td>
                <td class="fact-value">${W(i.value)}</td>
              </tr>
            `).join("")}
          </tbody>
        </table>`:"",a=e.links&&e.links.length>0?`<div class="kp-links">
          ${e.links.map(i=>`
            <a class="kp-link" href="${Se(i.url)}" target="_blank" rel="noopener">
              ${ws}
              <span>${W(i.title)}</span>
            </a>
          `).join("")}
        </div>`:"",n=e.source?`<div class="kp-source">Source: ${W(e.source)}</div>`:"";return`
    <div class="knowledge-panel" id="knowledge-panel">
      ${t}
      <div class="kp-title">${W(e.title)}</div>
      ${e.subtitle?`<div class="kp-subtitle">${W(e.subtitle)}</div>`:""}
      <div class="kp-description">${W(e.description)}</div>
      ${s}
      ${a}
      ${n}
    </div>
  `}function W(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Se(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const xs='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>',$s='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>';function ks(e){const{currentPage:t,hasMore:s,totalResults:a,perPage:n}=e,i=Math.min(Math.ceil(a/n),100);if(i<=1)return"";let r=Math.max(1,t-4),o=Math.min(i,r+9);o-r<9&&(r=Math.max(1,o-9));const l=[];for(let y=r;y<=o;y++)l.push(y);const c=Cs(t),v=t<=1?"disabled":"",h=!s&&t>=i?"disabled":"";return`
        ...
        ${e.map((t,s)=>`
          <div class="paa-item" data-index="${s}">
            <button class="paa-question" aria-expanded="false">
              <span>${Le(t.question)}</span>
              <span class="paa-chevron">${Rs}</span>
            </button>
            <div class="paa-answer hidden">
              ${t.answer?`<p class="paa-answer-text">${Le(t.answer)}</p>`:'<p class="paa-loading">Loading...</p>'}
              ${t.source&&t.url?`
  ...
  `}function Qs(e,t,s){const a=parseInt(s.page||"1"),n={timeRange:s.time_range||"",region:s.region||"",verbatim:s.verbatim==="1",site:s.site||""},i=Q.get().settings;_(r=>{e.navigate(`/search?q=${encodeURIComponent(r)}`)}),q(),Ds(r=>{const o=lt(t,r);e.navigate(o)}),t&&R(t),Js(e,t,a,n,i.results_per_page)}function lt(e,t,s){const a=new URLSearchParams;return a.set("q",e),s&&s>1&&a.set("page",String(s)),t.timeRange&&a.set("time_range",t.timeRange),t.region&&a.set("region",t.region),t.verbatim&&a.set("verbatim","1"),t.site&&a.set("site",t.site),`/search?${a.toString()}`}async function Js(e,t,s,a,n){const i=document.getElementById("search-content");if(!i||!t)return;let r=t;a.site&&(r=`site:${a.site} ${t}`);try{const o=await f.search(r,{page:s,per_page:n,time_range:a.timeRange||void 0,region:a.region||void 0,verbatim:a.verbatim||void 0});if(o.redirect){window.location.href=o.redirect;return}Zs(i,e,o,t,s,a)}catch(o){i.innerHTML=`
      <div class="py-8">
        <p class="text-red text-sm">Failed to load search results. Please try again.</p>
        <p class="text-tertiary text-xs mt-2">${Z(String(o))}</p>
      </div>
    `}}function Zs(e,t,s,a,n,i){const r=s.corrected_query?`<p class="text-sm text-secondary mb-4">
    ...
    <div class="min-h-screen flex flex-col">
      ...
      <div id="related-searches" class="related-searches-bar hidden">
        <div class="related-searches-scroll">
          <button class="related-scroll-btn related-scroll-left hidden">${ia}</button>
          <div class="related-searches-list"></div>
          <button class="related-scroll-btn related-scroll-right hidden">${ra}</button>
        </div>
      </div>
  ...
  `}function ye(e,t){return t==="any"?`Any ${e}`:t.charAt(0).toUpperCase()+t.slice(1).replace("_"," ")}function ca(e,t,s){if(de=t,A={},ue=1,N=[],G=!0,ie=!1,Te=[],_(a=>{e.navigate(`/images?q=${encodeURIComponent(a)}`)}),q(),t&&R(t),da(),ua(),ga(),fa(),ha(e),s?.reverse==="1"){const a=document.getElementById("reverse-modal");a&&a.classList.remove("hidden")}Ae(t,A)}function da(){const e=document.getElementById("tools-btn"),t=document.getElementById("filter-toolbar");!e||!t||e.addEventListener("click",()=>{ie=!ie,t.classList.toggle("hidden",!ie),e.classList.toggle("active",ie)})}function ua(e){const t=document.getElementById("filter-toolbar");if(!t)return;t.querySelectorAll(".filter-chip").forEach(a=>{a.addEventListener("click",n=>{n.stopPropagation();const i=a.dataset.filter,r=t.querySelector(`[data-dropdown="${i}"]`);t.querySelectorAll(".filter-dropdown").forEach(o=>{o!==r&&o.classList.add("hidden")}),r?.classList.toggle("hidden")})}),t.querySelectorAll(".filter-option").forEach(a=>{a.addEventListener("click",()=>{const n=a.closest(".filter-dropdown"),i=n?.dataset.dropdown,r=a.dataset.value,o=t.querySelector(`[data-filter="${i}"]`);!i||!r||!o||(n.querySelectorAll(".filter-option").forEach(l=>l.classList.remove("active")),a.classList.add("active"),r==="any"?(delete A[i],o.classList.remove("has-value"),o.querySelector(".filter-chip-label").textContent=ye(i,"any").replace("Any ","")):(A[i]=r,o.classList.add("has-value"),o.querySelector(".filter-chip-label").textContent=ye(i,r)),n.classList.add("hidden"),Ye(),ue=1,N=[],G=!0,Ae(de,A))})}),document.addEventListener("click",()=>{t.querySelectorAll(".filter-dropdown").forEach(a=>a.classList.add("hidden"))});const s=document.getElementById("clear-filters");s&&s.addEventListener("click",()=>{A={},ue=1,N=[],G=!0,t.querySelectorAll(".filter-chip").forEach(a=>{const n=a.dataset.filter;a.classList.remove("has-value"),a.querySelector(".filter-chip-label").textContent=ye(n,"any").replace("Any ","")}),t.querySelectorAll(".filter-dropdown").forEach(a=>{a.querySelectorAll(".filter-option").forEach((n,i)=>{n.classList.toggle("active",i===0)})}),Ye(),Ae(de,A)})}function Ye(){const e=document.getElementById("clear-filters");e&&e.classList.toggle("hidden",Object.keys(A).length===0)}function ha(e){const t=document.getElementById("related-searches");if(!t)return;t.addEventListener("click",i=>{const r=i.target.closest(".related-chip");if(r){const o=r.getAttribute("data-query");o&&e.navigate(`/images?q=${encodeURIComponent(o)}`)}});const s=t.querySelector(".related-scroll-left"),a=t.querySelector(".related-scroll-right"),n=t.querySelector(".related-searches-list");s&&a&&n&&(s.addEventListener("click",()=>{n.scrollBy({left:-200,behavior:"smooth"})}),a.addEventListener("click",()=>{n.scrollBy({left:200,behavior:"smooth"})}),n.addEventListener("scroll",()=>{dt()}))}function dt(){const e=document.getElementById("related-searches");if(!e)return;const t=e.querySelector(".related-searches-list"),s=e.querySelector(".related-scroll-left"),a=e.querySelector(".related-scroll-right");!t||!s||!a||(s.classList.toggle("hidden",t.scrollLeft<=0),a.classList.toggle("hidden",t.scrollLeft>=t.scrollWidth-t.clientWidth-10))}function pa(e){const t=document.getElementById("related-searches");if(!t)return;if(!e||e.length===0){t.classList.add("hidden");return}const s=t.querySelector(".related-searches-list");s&&(s.innerHTML=e.map(a=>`
    <button class="related-chip" data-query="${D(a)}">
      <span class="related-chip-text">${J(a)}</span>
    </button>
  `).join(""),t.classList.remove("hidden"),setTimeout(dt,50))}function ga(e){const t=document.getElementById("reverse-search-btn"),s=document.getElementById("reverse-modal"),a=document.getElementById("reverse-modal-close"),n=document.getElementById("drop-zone"),i=document.getElementById("image-upload"),r=document.getElementById("image-url-input"),o=document.getElementById("url-search-btn");!t||!s||(t.addEventListener("click",()=>s.classList.remove("hidden")),a?.addEventListener("click",()=>s.classList.add("hidden")),s.addEventListener("click",l=>{l.target===s&&s.classList.add("hidden")}),n&&(n.addEventListener("dragover",l=>{l.preventDefault(),n.classList.add("drag-over")}),n.addEventListener("dragleave",()=>n.classList.remove("drag-over")),n.addEventListener("drop",l=>{l.preventDefault(),n.classList.remove("drag-over");const c=l.dataTransfer?.files;c&&c[0]&&(Qe(c[0]),s.classList.add("hidden"))})),i&&i.addEventListener("change",()=>{i.files&&i.files[0]&&(Qe(i.files[0]),s.classList.add("hidden"))}),o&&r&&(o.addEventListener("click",()=>{const l=r.value.trim();l&&(Je(l),s.classList.add("hidden"))}),r.addEventListener("keydown",l=>{if(l.key==="Enter"){const c=r.value.trim();c&&(Je(c),s.classList.add("hidden"))}})))}async function Qe(e,t){const s=document.getElementById("images-content");if(s){if(!e.type.startsWith("image/")){alert("Please select an image file");return}if(e.size>10*1024*1024){alert("Image must be smaller than 10MB");return}s.innerHTML=`
  ...
  `;try{const a=await va(e),n=document.getElementById("upload-progress");n&&(n.style.width="50%");const i=await f.reverseImageSearchByUpload(a);n&&(n.style.width="100%"),ma(s,a,i)}catch(a){s.innerHTML=`
      <div class="py-8">
        <p class="text-red text-sm">Failed to search by image. Please try again.</p>
        <p class="text-tertiary text-xs mt-2">${J(String(a))}</p>
      </div>
    `}}}function va(e){return new Promise((t,s)=>{const a=new FileReader;a.onload=()=>{const i=a.result.split(",")[1];t(i)},a.onerror=s,a.readAsDataURL(e)})}function ma(e,t,s){const n=!t.startsWith("http")?`data:image/jpeg;base64,${t}`:t;e.innerHTML=`
      ...
      ${s.similar_images.length>0?`
        <div class="similar-images-section">
          ...
          <div class="image-grid">
            ${s.similar_images.map((i,r)=>ke(i,r)).join("")}
          </div>
        </div>
      `:'<div class="py-8 text-secondary">No similar images found.</div>'}
    </div>
  `,e.querySelectorAll(".image-card").forEach(i=>{i.addEventListener("click",()=>{const r=parseInt(i.dataset.imageIndex||"0",10);$e(s.similar_images[r])})})}async function Je(e,t){const s=document.getElementById("images-content");if(s){s.innerHTML=`
    <div class="flex items-center justify-center py-16">
      <div class="spinner"></div>
  ...
  `;try{const a=await f.reverseImageSearch(e);s.innerHTML=`
      <div class="reverse-results">
        <div class="query-image-section">
          <h3>Search image</h3>
          <img src="${D(e)}" alt="Query image" class="query-image" />
        </div>
        ${a.similar_images.length>0?`
          <div class="similar-images-section">
            <h3>Similar images (${a.similar_images.length})</h3>
            <div class="image-grid">
              ${a.similar_images.map((n,i)=>ke(n,i)).join("")}
            </div>
          </div>
        `:'<div class="py-8 text-secondary">No similar images found.</div>'}
      </div>
    `,s.querySelectorAll(".image-card").forEach(n=>{n.addEventListener("click",()=>{const i=parseInt(n.dataset.imageIndex||"0",10);$e(a.similar_images[i])})})}catch(a){s.innerHTML=`
      <div class="py-8">
        <p class="text-red text-sm">Failed to search by image. Please try again.</p>
        <p class="text-tertiary text-xs mt-2">${J(String(a))}</p>
      </div>
    `}}}function fa(){const e=document.getElementById("preview-panel"),t=document.getElementById("preview-close"),s=e?.querySelector(".preview-overlay");t?.addEventListener("click",Ee),s?.addEventListener("click",Ee),document.addEventListener("keydown",a=>{a.key==="Escape"&&Ee()})}function $e(e){const t=document.getElementById("preview-panel"),s=document.getElementById("preview-image"),a=document.getElementById("preview-details");if(!t||!s||!a)return;s.src=e.url,s.alt=e.title;const n=e.width&&e.height&&e.width>0&&e.height>0;a.innerHTML=`
    <div class="preview-header">
      <img src="${D(e.thumbnail_url||e.url)}" class="preview-thumb" alt="" />
      <div class="preview-header-info">
        <h3 class="preview-title">${J(e.title||"Untitled")}</h3>
        <a href="${D(e.source_url)}" target="_blank" class="preview-domain">${J(e.source_domain)}</a>
      </div>
    </div>
    ...
    <div class="preview-actions">
      <a href="${D(e.source_url)}" target="_blank" class="preview-btn preview-btn-primary">
        Visit page ${Ke}
      </a>
      <a href="${D(e.url)}" target="_blank" class="preview-btn">
        View full image ${Ke}
      </a>
    </div>
  `,t.classList.remove("hidden"),document.body.style.overflow="hidden"}function Ee(){const e=document.getElementById("preview-panel");e&&(e.classList.add("hidden"),document.body.style.overflow="")}function ya(){ge&&ge.disconnect();const e=document.getElementById("images-content");if(!e)return;const t=document.getElementById("scroll-sentinel");t&&t.remove();const s=document.createElement("div");s.id="scroll-sentinel",s.className="scroll-sentinel",e.appendChild(s),ge=new IntersectionObserver(a=>{a[0].isIntersecting&&!ee&&G&&de&&wa()},{rootMargin:"400px"}),ge.observe(s)}async function wa(){if(ee||!G)return;ee=!0,ue++;const e=document.getElementById("scroll-sentinel");e&&(e.innerHTML='<div class="loading-more"><div class="spinner-sm"></div></div>');try{const t=await f.searchImages(de,{...A,page:ue}),s=t.results;G=t.has_more,N=[...N,...s];const a=document.querySelector(".image-grid");if(a&&s.length>0){const n=N.length-s.length,i=s.map((r,o)=>ke(r,n+o)).join("");a.insertAdjacentHTML("beforeend",i),a.querySelectorAll(".image-card:not([data-initialized])").forEach(r=>{r.setAttribute("data-initialized","true"),r.addEventListener("click",()=>{const o=parseInt(r.dataset.imageIndex||"0",10);$e(N[o])})})}e&&(e.innerHTML=G?"":'<div class="no-more-results">No more images</div>')}catch{e&&(e.innerHTML="")}finally{ee=!1}}async function Ae(e,t){const s=document.getElementById("images-content");if(!(!s||!e)){ee=!0,s.innerHTML='<div class="flex items-center justify-center py-16"><div class="spinner"></div></div>';try{const a=await f.searchImages(e,{...t,page:1,per_page:50}),n=a.results;if(G=a.has_more,N=n,Te=a.related_searches?.length?a.related_searches:ba(e),pa(Te),n.length===0){s.innerHTML=`<div class="py-8 text-secondary">No image results found for "<strong>${J(e)}</strong>"</div>`;return}s.innerHTML=`<div class="image-grid">${n.map((i,r)=>ke(i,r)).join("")}</div>`,s.querySelectorAll(".image-card").forEach(i=>{i.setAttribute("data-initialized","true"),i.addEventListener("click",()=>{const r=parseInt(i.dataset.imageIndex||"0",10);$e(N[r])})}),ya()}catch(a){s.innerHTML=`
      <div class="py-8">
  ...
  `}function we(e,t){return{duration:{any:"Any duration",short:"Under 4 min",medium:"4-20 min",long:"Over 20 min"},time:{any:"Any time",hour:"Last hour",day:"Today",week:"This week",month:"This month",year:"This year"},quality:{any:"Any quality",hd:"HD","4k":"4K"},sort:{relevance:"Relevance",date:"Upload date",views:"View count"}}[e]?.[t]||t.charAt(0).toUpperCase()+t.slice(1)}function Sa(e,t){Ne=t,V={},re=!1,_(s=>{e.navigate(`/videos?q=${encodeURIComponent(s)}`)}),q(),La(),Ia(),t&&R(t),He(t,V)}function La(){const e=document.getElementById("tools-btn"),t=document.getElementById("filter-toolbar");!e||!t||e.addEventListener("click",()=>{re=!re,t.classList.toggle("hidden",!re),e.classList.toggle("active",re)})}function Ia(e){const t=document.getElementById("filter-toolbar");if(!t)return;t.querySelectorAll(".filter-chip").forEach(a=>{a.addEventListener("click",n=>{n.stopPropagation();const i=a.dataset.filter,r=t.querySelector(`[data-dropdown="${i}"]`);t.querySelectorAll(".filter-dropdown").forEach(o=>{o!==r&&o.classList.add("hidden")}),r?.classList.toggle("hidden")})}),t.querySelectorAll(".filter-option").forEach(a=>{a.addEventListener("click",()=>{const n=a.closest(".filter-dropdown"),i=n?.dataset.dropdown,r=a.dataset.value,o=t.querySelector(`[data-filter="${i}"]`);if(!i||!r||!o)return;n.querySelectorAll(".filter-option").forEach(c=>c.classList.remove("active")),a.classList.add("active");const l=r==="any"||i==="sort"&&r==="relevance";l?(delete V[i],o.classList.remove("has-value"),o.querySelector(".filter-chip-label").textContent=we(i,l?"any":r).replace(/^Any /,"")):(V[i]=r,o.classList.add("has-value"),o.querySelector(".filter-chip-label").textContent=we(i,r)),n.classList.add("hidden"),Ze(),He(Ne,V)})}),document.addEventListener("click",()=>{t.querySelectorAll(".filter-dropdown").forEach(a=>a.classList.add("hidden"))});const s=document.getElementById("clear-filters");s&&s.addEventListener("click",()=>{V={},t.querySelectorAll(".filter-chip").forEach(a=>{const n=a.dataset.filter;a.classList.remove("has-value");const i=n==="sort"?"Sort by":we(n,"any").replace(/^Any /,"");a.querySelector(".filter-chip-label").textContent=i}),t.querySelectorAll(".filter-dropdown").forEach(a=>{a.querySelectorAll(".filter-option").forEach((n,i)=>{n.classList.toggle("active",i===0)})}),Ze(),He(Ne,V)})}function Ze(){const e=document.getElementById("clear-filters");e&&e.classList.toggle("hidden",Object.keys(V).length===0)}async function He(e,t){const s=document.getElementById("videos-content");if(!(!s||!e)){s.innerHTML='<div class="flex items-center justify-center py-16"><div class="spinner"></div></div>';try{const a=await f.searchVideos(e,{page:1,per_page:24,...t}),n=a.results;if(n.length===0){s.innerHTML=`
  ...
  `}function pt(e,t){return{time:{any:"Any time",hour:"Past hour",day:"Past 24 hours",week:"Past week",month:"Past month",year:"Past year"},sort:{relevance:"Relevance",date:"Date"}}[e]?.[t]||t.charAt(0).toUpperCase()+t.slice(1)}function Ha(e,t){Re=t,z={},oe=!1,_(s=>{e.navigate(`/news?q=${encodeURIComponent(s)}`)}),q(),Ra(),Oa(),t&&R(t),Oe(t,z)}function Ra(){const e=document.getElementById("tools-btn"),t=document.getElementById("filter-toolbar");!e||!t||e.addEventListener("click",()=>{oe=!oe,t.classList.toggle("hidden",!oe),e.classList.toggle("active",oe)})}function Oa(){const e=document.getElementById("filter-toolbar");if(!e)return;e.querySelectorAll(".filter-chip").forEach(s=>{s.addEventListener("click",a=>{a.stopPropagation();const n=s.dataset.filter,i=e.querySelector(`[data-dropdown="${n}"]`);e.querySelectorAll(".filter-dropdown").forEach(r=>{r!==i&&r.classList.add("hidden")}),i?.classList.toggle("hidden")})}),e.querySelectorAll(".filter-option").forEach(s=>{s.addEventListener("click",()=>{const a=s.closest(".filter-dropdown"),n=a?.dataset.dropdown,i=s.dataset.value,r=e.querySelector(`[data-filter="${n}"]`);if(!n||!i||!r)return;a.querySelectorAll(".filter-option").forEach(l=>l.classList.remove("active")),s.classList.add("active"),i==="any"||n==="sort"&&i==="relevance"?(delete z[n],r.classList.remove("has-value"),r.querySelector(".filter-chip-label").textContent=n==="sort"?"Sort by":"Time"):(z[n]=i,r.classList.add("has-value"),r.querySelector(".filter-chip-label").textContent=pt(n,i)),a.classList.add("hidden"),Xe(),Oe(Re,z)})}),document.addEventListener("click",()=>{e.querySelectorAll(".filter-dropdown").forEach(s=>s.classList.add("hidden"))});const t=document.getElementById("clear-filters");t&&t.addEventListener("click",()=>{z={},e.querySelectorAll(".filter-chip").forEach(s=>{const a=s.dataset.filter;s.classList.remove("has-value"),s.querySelector(".filter-chip-label").textContent=a==="sort"?"Sort by":"Time"}),e.querySelectorAll(".filter-dropdown").forEach(s=>{s.querySelectorAll(".filter-option").forEach((a,n)=>{a.classList.toggle("active",n===0)})}),Xe(),Oe(Re,z)})}function Xe(){const e=document.getElementById("clear-filters");e&&e.classList.toggle("hidden",Object.keys(z).length===0)}async function Oe(e,t){const s=document.getElementById("news-content");if(!(!s||!e)){s.innerHTML='<div class="flex items-center justify-center py-16"><div class="spinner"></div></div>';try{const a=await f.searchNews(e,{page:1,per_page:20,time_range:t.time}),n=a.results;if(n.length===0){s.innerHTML=`
        <div class="py-8 text-secondary">No news results found for "<strong>${H(e)}</strong>"</div>
      `;return}const i=n.slice(0,5),r=n.slice(5),o=i.length>0?`
    ...
    `}catch(a){s.innerHTML=`
      <div class="py-8">
        ...
        <p class="text-tertiary text-xs mt-2">${H(String(a))}</p>
      </div>
    ...
    <a href="${be(e.url)}" target="_blank" rel="noopener" class="news-top-card">
      ...
      <div class="news-top-card-content">
        <div class="news-source">
          ...
          <span>${H(e.source||e.domain)}</span>
          ${s?`<span class="news-time">· ${H(s)}</span>`:""}
        </div>
        <h3 class="news-top-card-title">${H(e.title)}</h3>
      </div>
    </a>
    ...
    <article class="news-card-item">
      <div class="news-card-main">
        <div class="news-card-source">
          ...
          <span>${H(e.source||e.domain)}</span>
          ${s?`<span class="news-card-time">· ${H(s)}</span>`:""}
        </div>
        <h3 class="news-card-headline">
          <a href="${be(e.url)}" target="_blank" rel="noopener">${H(e.title)}</a>
        </h3>
        <p class="news-card-snippet">${H(e.snippet||"")}</p>
      </div>
  ...
  `}function Za(e,t){_(n=>{e.navigate(`/news?q=${encodeURIComponent(n)}`)});const s=document.getElementById("menu-toggle"),a=document.querySelector(".news-sidebar");s&&a&&s.addEventListener("click",()=>{a.classList.toggle("open")}),Xa()}async function Xa(e){const t=document.getElementById("news-loading"),s=document.getElementById("top-stories-section"),a=document.getElementById("for-you-section"),n=document.getElementById("local-section");try{const i=await f.newsHome();if(t&&(t.style.display="none"),s&&i.topStories.length>0){s.style.display="block";const o=document.getElementById("top-stories-grid");o&&(o.innerHTML=en(i.topStories))}if(a&&i.forYou.length>0){a.style.display="block";const o=document.getElementById("for-you-list");o&&(o.innerHTML=i.forYou.slice(0,10).map(l=>nn(l)).join(""))}if(n&&i.localNews.length>0){n.style.display="block";const o=document.getElementById("local-news-scroll");o&&(o.innerHTML=i.localNews.map(l=>ft(l)).join(""))}const r=document.getElementById("category-sections");if(r&&i.categories){const o=Object.entries(i.categories).filter(([l,c])=>c&&c.length>0).map(([l,c])=>rn(l,c)).join("");r.innerHTML=o}on()}catch(i){t&&(t.innerHTML=`
        <div class="news-error">
          <p>Failed to load news. Please try again.</p>
          <button class="news-btn" onclick="location.reload()">Retry</button>
        </div>
      `),console.error("Failed to load news:",i)}}function en(e){if(e.length===0)return"";const t=e[0],s=e.slice(1,3),a=e.slice(3,9);return`
  ...
  `}function hn(e,t){_(s=>{e.navigate(`/science?q=${encodeURIComponent(s)}`)}),q(),t&&R(t),pn(t)}async function pn(e){const t=document.getElementById("science-content");if(!(!t||!e))try{const s=await f.searchScience(e),a=s.results;if(a.length===0){t.innerHTML=`
        <div class="w-full">
          <div class="py-8 text-secondary">No academic results found for "<strong>${K(e)}</strong>"</div>
        </div>
      `;return}t.innerHTML=`
      <div class="w-full">
        <div class="text-xs text-tertiary mb-4">
  ...
  `}function xn(e,t){_(s=>e.navigate(`/code?q=${encodeURIComponent(s)}`)),q(),t&&R(t),$n(t)}async function $n(e){const t=document.getElementById("code-content");if(!(!t||!e))try{const s=await f.searchCode(e),a=s.results;if(a.length===0){t.innerHTML=`<div class="py-8 text-secondary">No code results found for "${le(e)}"</div>`;return}t.innerHTML=`
      <div class="text-xs text-tertiary mb-4">
        About ${s.total_results.toLocaleString()} results (${(s.search_time_ms/1e3).toFixed(2)} seconds)
      </div>
    ...
    `}catch(s){t.innerHTML=`<div class="py-8 text-red text-sm">Failed to load results. ${le(String(s))}</div>`}}function kn(e){const t=e.metadata?.source||Sn(e.url),s=e.metadata?.stars,a=e.metadata?.forks,n=e.metadata?.downloads,i=e.metadata?.language||"",r=e.metadata?.votes,o=e.metadata?.answers;return`
    <article class="code-card bg-white border border-border rounded-xl p-4 hover:shadow-md transition-shadow">
      <div class="flex items-start gap-3 mb-2">
        ...
        ${i?`<span class="text-xs px-2 py-0.5 bg-surface text-secondary rounded-full">${le(i)}</span>`:""}
      </div>
      ...
      <div class="flex items-center gap-4 text-xs text-tertiary">
        ...
        ${r!==void 0?`<span class="flex items-center gap-1">▲ ${me(r)}</span>`:""}
  ...
  `}function Mn(e,t){_(s=>e.navigate(`/music?q=${encodeURIComponent(s)}`)),q(),t&&R(t),Tn(t)}async function Tn(e){const t=document.getElementById("music-content");if(!(!t||!e))try{const s=await f.searchMusic(e),a=s.results;if(a.length===0){t.innerHTML=`<div class="py-8 text-secondary">No music results found for "${U(e)}"</div>`;return}t.innerHTML=`
      <div class="text-xs text-tertiary mb-4">
        About ${s.total_results.toLocaleString()} results (${(s.search_time_ms/1e3).toFixed(2)} seconds)
      </div>
    ...
    `}catch(s){t.innerHTML=`<div class="py-8 text-red text-sm">Failed to load results. ${U(String(s))}</div>`}}function An(e){const t=e.metadata?.source||Hn(e.url),s=e.metadata?.artist||"",a=e.metadata?.album||"",n=e.metadata?.duration||"",i=e.thumbnail?.url||"",r=t.toLowerCase().includes("genius");return`
    <article class="music-card bg-white border border-border rounded-xl overflow-hidden hover:shadow-md transition-shadow">
      <a href="${tt(e.url)}" target="_blank" rel="noopener" class="block">
        <div class="relative aspect-square bg-surface">
          ${i?`<img src="${tt(i)}" alt="" class="w-full h-full object-cover" loading="lazy" onerror="this.style.display='none'" />`:`<div class="w-full h-full flex items-center justify-center text-border">${_n}</div>`}
  ...
  `}function Pn(e,t){_(s=>e.navigate(`/social?q=${encodeURIComponent(s)}`)),q(),t&&R(t),Un(t)}async function Un(e){const t=document.getElementById("social-content");if(!(!t||!e))try{const s=await f.searchSocial(e),a=s.results;if(a.length===0){t.innerHTML=`<div class="py-8 text-secondary">No social results found for "${Y(e)}"</div>`;return}t.innerHTML=`
      <div class="text-xs text-tertiary mb-4">
        About ${s.total_results.toLocaleString()} results (${(s.search_time_ms/1e3).toFixed(2)} seconds)
      </div>
      <div class="w-full space-y-4">
    ...
    `}catch(s){t.innerHTML=`<div class="py-8 text-red text-sm">Failed to load results. ${Y(String(s))}</div>`}}function Fn(e){const t=e.metadata||{},s=t.source||Dn(e.url),a=t.upvotes||t.score||0,n=t.comments||0,i=t.author||"",r=t.subreddit||"",o=t.published||"",l=e.thumbnail?.url||"",c=e.snippet||"";return`
      ...
      <div class="flex items-start gap-3">
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-center gap-2 mb-1 flex-wrap">
            ...
            ${r?`<span class="text-xs text-blue">r/${Y(r)}</span>`:""}
            ${i?`<span class="text-xs text-tertiary">by ${Y(i)}</span>`:""}
  ...
  `}function Kn(e,t){_(s=>e.navigate(`/maps?q=${encodeURIComponent(s)}`)),q(),t&&R(t),Yn(t)}async function Yn(e){const t=document.getElementById("maps-content"),s=document.getElementById("map-iframe");if(!(!t||!e)){if(s){const a="https://www.openstreetmap.org/export/embed.html?bbox=-180,-90,180,90&layer=mapnik&marker=0,0";s.src=a}try{const n=(await f.searchMaps(e)).results;if(n.length===0){t.innerHTML=`<div class="p-4 text-secondary">No locations found for "${ce(e)}"</div>`;return}const i=n[0],r=i.metadata?.lat||0,o=i.metadata?.lon||0;if(s&&r&&o){const l=`${o-.1},${r-.1},${o+.1},${r+.1}`;s.src=`https://www.openstreetmap.org/export/embed.html?bbox=${l}&layer=mapnik&marker=${r},${o}`}t.innerHTML=`
      <div class="p-4">
    ...
    <article class="location-card bg-white border border-border rounded-lg p-3 cursor-pointer hover:shadow-md transition-shadow"
      ...
      <div class="flex items-start gap-3">
        ...
        <div class="flex-1 min-w-0">
          ...
          ${i?`<p class="text-xs text-secondary mt-1 line-clamp-2">${ce(i)}</p>`:""}
        ...
        <form id="settings-form">
          ...
          <div class="settings-section">
            ...
            <select name="region" class="settings-select">
              ${Xn.map(t=>`<option value="${t.value}" ${e.region===t.value?"selected":""}>${it(t.label)}</option>`).join("")}
            </select>
          </div>
          ...
          <div class="settings-section">
            ...
            <select name="language" class="settings-select">
              ${ei.map(t=>`<option value="${t.value}" ${e.language===t.value?"selected":""}>${it(t.label)}</option>`).join("")}
            </select>
          </div>
  ...
  `}function si(e){const t=document.getElementById("settings-form"),s=document.getElementById("settings-status");t&&t.addEventListener("submit",async a=>{a.preventDefault();const n=new FormData(t),i={safe_search:n.get("safe_search")||"moderate",results_per_page:parseInt(n.get("results_per_page"))||10,region:n.get("region")||"auto",language:n.get("language")||"en",theme:n.get("theme")||"light",open_in_new_tab:n.has("open_in_new_tab"),show_thumbnails:n.has("show_thumbnails")};Q.set({settings:i});try{await f.updateSettings(i)}catch{}s&&(s.classList.remove("hidden"),setTimeout(()=>{s.classList.add("hidden")},2e3))})}function it(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const ai='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12 19-7-7 7-7"/><path d="M19 12H5"/></svg>',ni='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',ii='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>',ri='<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#dadce0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/><path d="M12 7v5l4 2"/></svg>';function oi(){return`
    <div class="min-h-screen bg-white">
      <!-- Header -->
      <header class="border-b border-border">
  ...
  `}function li(e){const t=document.getElementById("clear-all-btn");ci(e),t?.addEventListener("click",async()=>{if(confirm("Are you sure you want to clear all search history?"))try{await f.clearHistory(),je(),t.classList.add("hidden")}catch(s){console.error("Failed to clear history:",s)}})}async function ci(e){const t=document.getElementById("history-content"),s=document.getElementById("clear-all-btn");if(t)try{const a=await f.getHistory();if(a.length===0){je();return}s&&s.classList.remove("hidden"),t.innerHTML=`
      <div id="history-list">
        ${a.map(n=>di(n)).join("")}
      </div>
    `,ui(e)}catch(a){t.innerHTML=`
      <div class="py-8 text-center">
        <p class="text-red text-sm">Failed to load search history.</p>
        <p class="text-tertiary text-xs mt-2">${qe(String(a))}</p>
      </div>
    `}}function di(e){const t=hi(e.searched_at);return`
    <div class="history-item flex items-center gap-3 py-3 px-2 border-b border-border hover:bg-surface-hover rounded transition-colors group" data-history-id="${rt(e.id)}">
      <span class="text-light flex-shrink-0">${ii}</span>
      <div class="flex-1 min-w-0">
      ...
      <button class="history-delete-btn text-light hover:text-red p-1.5 rounded-full hover:bg-red/10 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0 cursor-pointer"
              data-delete-id="${rt(e.id)}" aria-label="Delete">
        ${ni}
      </button>
    </div>
  `}function ui(e){document.querySelectorAll(".history-delete-btn").forEach(t=>{t.addEventListener("click",async s=>{s.preventDefault(),s.stopPropagation();const a=t.dataset.deleteId||"",n=t.closest(".history-item");try{await f.deleteHistoryItem(a),n&&n.remove();const i=document.getElementById("history-list");if(i&&i.children.length===0){je();const r=document.getElementById("clear-all-btn");r&&r.classList.add("hidden")}}catch(i){console.error("Failed to delete history item:",i)}})})}function je(){const e=document.getElementById("history-content");e&&(e.innerHTML=`
  ...
  `});window.addEventListener("router:navigate",e=>{const t=e;m.navigate(t.detail.path)});m.start();function pi(){document.addEventListener("keydown",e=>{const t=e.target,s=t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.isContentEditable;if(e.key==="/"&&!s){e.preventDefault();const a=document.getElementById("search-input");a&&(a.focus(),a.select())}e.key==="Escape"&&(document.querySelectorAll(".modal:not(.hidden), .preview-panel:not(.hidden), .lightbox:not(.hidden)").forEach(i=>{i.classList.add("hidden")}),document.querySelectorAll(".autocomplete-dropdown:not(.hidden), .filter-dropdown:not(.hidden), .filter-pill-dropdown:not(.hidden), .more-tabs-dropdown:not(.hidden), .time-filter-dropdown:not(.hidden), .search-tool-menu:not(.hidden)").forEach(i=>{i.classList.add("hidden")}),document.body.style.overflow="",document.activeElement?.id==="search-input"&&document.activeElement.blur()),e.key==="?"&&!s&&gi()})}function gi(){let e=document.getElementById("keyboard-shortcuts-help");if(e){e.classList.toggle("hidden");return}e=document.createElement("div"),e.id="keyboard-shortcuts-help",e.className="modal",e.innerHTML=`
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&e.classList.add("hidden")}),document.getElementById("shortcuts-close")?.addEventListener("click",()=>{e.classList.add("hidden")})}pi();"serviceWorker"in navigator&&(navigator.serviceWorker.getRegistrations().then(e=>{for(const t of e)t.unregister()}),"caches"in window&&caches.keys().then(e=>{for(const t of e)caches.delete(t)}));
