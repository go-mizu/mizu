...
func NewInit() *cobra.Command {
	return &cobra.Command{
		Use:   "init",
		Short: "Initialize the news database",
...
func runInit(cmd *cobra.Command, args []string) error {
	...
	ui.Header(iconInfo, "Initializing News Database")
	ui.Blank()
	...
	ui.Blank()
	ui.Hint("Next: run 'news seed hn' to import HN stories, or 'news serve' to start the server")
