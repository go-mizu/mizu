...
- [Request](/concepts/request) - Read input from requests
- [Streaming](/concepts/response#streaming-responses) - Real-time data delivery
- [Error handling](/concepts/error) - Handle response errors
