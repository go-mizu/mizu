...
func TestCreate(t *testing.T) {
    ...
    result, err := svc.Create(context.Background(), &CreateInput{Title: "Test"})
...
func TestREST_Create(t *testing.T) {
    // Setup
    svc, _ := contract.Register("todo", todo.NewService())
...
func setupTestServer(t *testing.T) (*httptest.Server, func()) {
    ...
    svc, err := contract.Register("todo", todo.NewService())
    if err != nil {
...
func TestIntegration(t *testing.T) {
    ...
    resp, _ := http.Post(server.URL+"/todos", "application/json",
...
// Helper function
func assertErrorCode(t *testing.T, err error, want contract.ErrCode) {
    t.Helper()
    var contractErr *contract.Error
    if !errors.As(err, &contractErr) {
...
- [Defining Services](/contract/service) - Writing testable services
