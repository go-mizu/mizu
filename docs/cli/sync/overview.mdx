...
The sync template creates offline-first applications where data syncs automatically between client and server. Users can work offline, and changes merge when they reconnect.
