...
The `mizu dev` command runs your Mizu application in development mode. It automatically finds your main package, starts your server, and handles shutdown gracefully when you press Ctrl+C.
