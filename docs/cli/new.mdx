...
The `mizu new` command creates a new Mizu project by generating files from a template. It's the fastest way to start a new project with all the boilerplate already set up.
