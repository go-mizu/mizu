...
The contract template creates a service based on transport-neutral contracts. Define your API once as Go methods, then expose it via REST, JSON-RPC, and automatically generate OpenAPI documentation.
