---
title: "Contract Template Tutorial"
description: "Build a multi-protocol API service"
---

# Contract Template Tutorial

In this tutorial, you'll build a notes service that exposes both REST and JSON-RPC endpoints, with automatic OpenAPI documentation.
