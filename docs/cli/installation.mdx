...
This guide will help you install the Mizu CLI on your computer. We'll cover everything from checking prerequisites to verifying your installation works.
