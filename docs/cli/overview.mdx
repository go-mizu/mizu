...
A CLI is a program you run in your terminal (also called command prompt or shell). Instead of clicking buttons in a graphical interface, you type commands. For example:

```bash
mizu new myapp --template api
```

This command tells the Mizu CLI to create a new project called "myapp" using the "api" template.
...
The Mizu CLI has four main commands:
...
<CardGroup cols={2}>
  ...
  <Card title="Create Your First Project" icon="rocket" href="/cli/new">
