...
By default, sync clients must poll the server for changes. By integrating with the `live` package, you can push notifications to clients for instant updates.
