...
| gen/bindgen         | bindgen     | Package bindgen writes the BindRequest method for a request struct.                                                                                                                    |
...
| gen/validategen     | validategen | Package validategen writes the Validate method for a request struct.                                                                                                                   |
...
| validate            | validate    | Package validate says what is wrong with a value, in one shape that a response, a form redisplay and a log line can all read.                                                          |
| web                 | web         | Package web is the request handle a handler is written against.                                                                                                                        |
| web/mw              | mw          | Package mw is the middleware nearly every service ends up writing.                                                                                                                     |
