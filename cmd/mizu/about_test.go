...
func TestAboutAsJSON(t *testing.T) {
	...
	want := []generated{
		{By: "mizu gen agents v1", Files: []string{"AGENTS.md"}},
		{By: "mizu gen command v1", Files: []string{"app/commands_gen.go"}},
	}
	if got := inv.Generated; !slices.EqualFunc(got, want, func(a, b generated) bool {
		return a.By == b.By && slices.Equal(a.Files, b.Files)
	}) {
...
func TestGeneratedIn(t *testing.T) {
	...
	fsys := fstest.MapFS{
		...
		// A header that names nobody is still a header, and the file is still
		// not one to edit by hand.
		"db/schema.sql":           {Data: []byte("-- Code generated DO NOT EDIT.\n")},
	...
	want := []generated{
		...
		{By: "unknown", Files: []string{"db/schema.sql"}},
	}
	if len(got) != len(want) {
